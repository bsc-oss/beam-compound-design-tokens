...
data class SemanticColors(
    /** Background colour for accent or brand actions. State: Hover (PG_CHANGED) */
    val bgAccentHovered: Color,
    /** Background colour for accent or brand actions. State: Pressed (PG_CHANGED) */
    val bgAccentPressed: Color,
    /** Background colour for accent or brand actions. State: Rest. (PG_CHANGED) */
    val bgAccentRest: Color,
    /** Background colour for accent or brand actions. State: Selected */
    val bgAccentSelected: Color,
    /** Background colour for primary actions. State: Disabled. (PG_CHANGED) */
    val bgActionPrimaryDisabled: Color,
    /** Background colour for primary actions. State: Hover. (PG_CHANGED) */
    val bgActionPrimaryHovered: Color,
    /** Background colour for primary actions. State: Pressed. (PG_CHANGED) */
    val bgActionPrimaryPressed: Color,
    /** Background colour for primary actions. State: Rest. (PG_CHANGED) */
    ...
    /** Background colour for current user mention pills. (PG_CHANGED) */
    val bgMentionUser: Color,
    /** Medium contrast surfaces. Elevation: Default (Level 2). (PG_CHANGED) */
    ...
    /** Low contrast surfaces. Elevation: Default (Level 1). (PG_CHANGED) */
    ...
    /** accent border intended for keylines on message highlights (PG_CHANGED) */
    ...
    /** Used for the focus state outline. (PG_CHANGED) */
    ...
    /** Background gradient stop for super and send buttons (PG_CHANGED) */
    ...
    /** Subtle background gradient stop for message highlight and bloom (PG_CHANGED) */
    ...
    /** Highest contrast accessible accent icons. (PG_CHANGED) */
    val iconAccentPrimary: Color,
    /** Lowest contrast accessible accent icons. (PG_CHANGED) */
    ...
    /** Text colour for current user mention pills. (PG_CHANGED) */
    val textMentionUser: Color,
    ...
    /** Lowest contrast text. (PG_CHANGED) */
