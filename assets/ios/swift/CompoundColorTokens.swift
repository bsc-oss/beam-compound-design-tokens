...
public class CompoundColorTokens {
    ...
    public let bgMentionUser = Color("bgMentionUser", bundle: Bundle.module)
    ...
    public let bgSubtleTertiary = Color("bgSubtleTertiary", bundle: Bundle.module)
    ...
    public let textMentionUser = Color("textMentionUser", bundle: Bundle.module)
